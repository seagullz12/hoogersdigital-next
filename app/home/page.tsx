            ...
            <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
              <Card className="shadow-card hover:shadow-elegant transition-shadow duration-300">
                <CardHeader>
                  <CardTitle className="flex items-center gap-2">
                    <Image src="/Heyloha - logo - Google My Business.png" alt="Heyloha logo" width={500} height={300} />
                    Heyloha
                  </CardTitle>
              ...
              <Card className="shadow-card hover:shadow-elegant transition-shadow duration-300">
                ...
                <CardContent>
                  ...
                  <Button asChild variant="outline" size="sm">
                    <Link href="https://hoogersdigital.nl" target="_blank" rel="noopener noreferrer">
        ...
        <section className="py-20 bg-gradient-hero text-white" aria-label="Call to action">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-lg opacity-90 mb-8 max-w-2xl mx-auto">
              <p>Ready to leverage AI, data analytics, and automation for measurable growth? Let&apos;s discuss your project.</p>
            </p>
